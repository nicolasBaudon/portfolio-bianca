...
export const Section2 = () => (
  <Stack sx={styles.container}>
    <h3>
      ...
      security, blockchain and NFT's sounds abstract or difficult to understand.
    </h3>
    <p>
      The truth is that today, in the ticket resale market, people do not care
      enough about their security when carrying out this type of transaction, to
      perform them through a web application that uses new technologies,
