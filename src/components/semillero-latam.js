  ...
  return (
    <section className={[styles.latechFactoryIntro, className].join(" ")}>
      ...
      <div className={styles.devices}>
        <StaticImage className={styles.imacIcon} loading="lazy" alt="" src='../images/imac-1@2x.png' />
      </div>
    </section>
  );
};

SemilleroLatam.propTypes = {
